...
func init() {
	m.Register(func(app core.App) error {
		jsonData := `{
			...
			"id": "pbc_1079353916",
			"indexes": [
				"CREATE UNIQUE INDEX ` + "`" + `idx_tokenKey_pbc_1079353916` + "`" + ` ON ` + "`" + `staff_accounts` + "`" + ` (` + "`" + `tokenKey` + "`" + `)",
				"CREATE UNIQUE INDEX ` + "`" + `idx_email_pbc_1079353916` + "`" + ` ON ` + "`" + `staff_accounts` + "`" + ` (` + "`" + `email` + "`" + `) WHERE ` + "`" + `email` + "`" + ` != ''"
			],
			"listRule": "",
			"manageRule": null,
			"mfa": {
