...
migrate((app) => {
  const collection = new Collection({
    ...
    "id": "pbc_3551159185",
    "indexes": [
      "CREATE UNIQUE INDEX `idx_tokenKey_pbc_3551159185` ON `web_users` (`tokenKey`)",
      "CREATE UNIQUE INDEX `idx_email_pbc_3551159185` ON `web_users` (`email`) WHERE `email` != ''"
    ],
  ...
  const collection = app.findCollectionByNameOrId("pbc_3551159185");
